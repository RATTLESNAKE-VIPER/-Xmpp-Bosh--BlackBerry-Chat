...
public class MessageScreen extends MainScreen {
	...
	public void sendMessage(String from, String to, String name, String msg, boolean showTitle, String time) {
		...
		MessageModel messageModel = new MessageModel(MessageModel.TYPE_OUT, name, msg);
	...
	public void receiveMessage(String from, String to, String name, String msg, boolean current, boolean showTitle, String time) {
		HorizontalFieldManager chatContainer = new HorizontalFieldManager(USE_ALL_WIDTH);
		chatContainer.setMargin(10, 10, 5, 10);
		//bubbleManager.add(chatContainer);
		bubbleManager.insert(chatContainer, bubbleManager.getFieldCount()-1);
		...
		MessageModel messageModel = new MessageModel(MessageModel.TYPE_IN, name, msg);
