...
public class ConnectionFactory {
	 ...
	 */
	public ConnectionFactory( String url, int allowedTransports ) {
	 ...
	 */
	public ConnectionFactory( String url, int transportPriority[] ) {
	 ...
	 */
	public ConnectionFactory( String url, String extraParameters, int allowedTransports ) {
	 ...
	 */
	public ConnectionFactory( String url, String extraParameters, int transportPriority[] ) {
	 ...
	 */
	public Connection getNextConnection() throws NoMoreTransportsException, ConnectionNotFoundException, IllegalArgumentException, IOException {
		Connection con = null;
		int curTransport = 0;
	 ...
	 */
	private Connection getBisConnection( int index ) throws NoMoreTransportsException, IOException, ConnectionNotFoundException, IllegalArgumentException {
	 ...
	 * @throws IOException throws exceptions generated by {@link getConnection( String transportExtras1, String transportExtras2 )}
	 */
	private Connection getBesConnection( ) throws IOException, ConnectionNotFoundException, IllegalArgumentException {
	 ...
	 * @throws IOException throws exceptions generated by {@link getConnection( String transportExtras1, String transportExtras2 )}
	 */
	private Connection getWifiConnection() throws IOException, ConnectionNotFoundException, IllegalArgumentException {
	 ...
	 * @throws IOException throws exceptions generated by {@link getConnection( String transportExtras1, String transportExtras2 )}
	 */
	private Connection getWap2Connection( int index ) throws NoMoreTransportsException, IOException, ConnectionNotFoundException, IllegalArgumentException {
	 ...
	 * @throws IOException throws exceptions generated by {@link getConnection( String transportExtras1, String transportExtras2 )}
	 */
	private Connection getTcpConnection( ) throws IOException, ConnectionNotFoundException, IllegalArgumentException {
		if( CoverageInfo.isCoverageSufficient( 1 /* CoverageInfo.COVERAGE_DIRECT */ ) ) {
	 ...
	 */
	private Connection getConnection( String transportExtras1, String transportExtras2 ) throws IOException, ConnectionNotFoundException, IllegalArgumentException {
		...
		return Connector.open( fullUrl.toString() );
	}
